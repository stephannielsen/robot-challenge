...
{
    public static IEnumerable<object[]> CleaningPathData => new List<object[]>
    {
        new object[] { new CleaningPath { Start = new Coordinate { X = 10, Y = 22 }, Commands = [new Command { Direction = Direction.East, Steps = 2 }, new Command { Direction = Direction.North, Steps = 1 }] }, 4 },
        new object[] { new CleaningPath { Start = new Coordinate { X = -43695, Y = -52014 }, Commands = [
        ...
        new object[] { new CleaningPath { Start = new Coordinate { X = 44743, Y = 74509 }, Commands = [
